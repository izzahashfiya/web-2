...
<head>
    ...
    <style>
        .harga-container {
            ...
            padding: 20px;
            border-radius: 5px;
            background: linear-gradient(145deg, #2980B9, primary(255, 248, 225, 0.72));
        }
        .harga-container h4 {
            margin-bottom: 20px;
        }
        ...
        <div class="row">
            <div class="col-md-6">
                <form method="POST" action="">
                    <fieldset class="border border-dark text-black p-3 rounded" style="background-color: #2980B9;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="namacus" name="namacus" placeholder="*Izzahazzi" type="text" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
