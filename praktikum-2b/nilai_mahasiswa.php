...
<div class="mx-auto mt-5 border border-2 border-belize p-3 bg-belize text-dark rounded" style="width: 45%; bg-color: #2980B9">
    <h3>Hasil Nilai Mahasiswa</h3>
    <table class="table table-bordered border-belize mt-3 text-dark w-75 mx-auto">
      <thead>
        <tr>
